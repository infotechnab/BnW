...
<div  class="container-fluid">
    <div class="row">
        <div class="col-md-2 col-sm-3 col-xs-4 col-lg-2 leftside " >
            <div class="menuItems" >
             <ul class="menu" >
                 <li class="mainMenuItem dashboard active"> 
                     <a  href="<?php echo base_url('bnw'); ?>" ><i class="fa fa-home"></i> &nbsp;Dashboard</a>
                    ...
                    <li class="mainMenuItem events">
                        <a href="#"><i class="fa fa-newspaper-o"></i>&nbsp;
                         ...
                         <ul class="subMenu">
                            ...
                            <li><?php echo anchor('events/addevent', 'Add Event/news ') ?></li>
                        </ul>
                    </li>
                    <!-- for posta -->
                    ...
                    <li class="mainMenuItem media" style="margin-top:-3px;">
